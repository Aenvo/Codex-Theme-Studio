...
public sealed class CodexVersionPolicyTests
{
    ...
    public void DefaultPolicy_AcceptsRecordedVersionAndRejectsUnknownVersion()
    {
        ...
        Assert.True(policy.IsVerified("26.730.8199.0"));
        Assert.True(policy.IsVerified("26.803.5235.0"));
        Assert.True(policy.IsVerified("26.803.10989.0"));
        ...
        Assert.False(policy.IsVerified("26.730.8199.1"));
        Assert.False(policy.IsVerified("26.803.5235.1"));
        Assert.False(policy.IsVerified("26.803.10989.1"));
